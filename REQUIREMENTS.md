...
|---|---|---|---|
| **FR-1** | M0 | **Skill scaffold**: an agent skill (`SKILL.md` + frontmatter) discoverable in `~/.gemini/config/skills/`, English-only, no runtime deps. | Skill loads; `description` matches the workflow intent; offline tests pass. |
